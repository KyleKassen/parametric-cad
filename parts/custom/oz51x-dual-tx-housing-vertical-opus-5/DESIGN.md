# OZ51x Dual-TX Vertical Housing — Opus 5 production refinement

Independent redesign of `oz51x-dual-tx-housing-vertical`, authored by Claude
(**Opus 5**). The RX peer is `../oz51x-dual-rx-housing-vertical-opus-5/` and
...
```bash
uv run python parts/custom/oz51x-dual-tx-housing-vertical-opus-5/model.py      # build + export
uv run python parts/custom/oz51x-dual-tx-housing-vertical-opus-5/fit_check.py  # 7 real-geometry checks
uv run python parts/custom/oz51x-dual-tx-housing-vertical-opus-5/make_views.py # renders
