...
def main(out):
    ...
    for n,expected in [('B210_M01_base_P1',[160,180,12]),('B210_M02_retainer_P1',[160,20,8]),
                       ('B210_M03_spacer_P1',[12,12,30]),('B210_M04_film_P1',[16,20,.2])]:
    ...
    for y in va.PARAMS['bracket_y_centers']:
        for z in va.PARAMS['web_hole_z']:
            rear=m.cylinder(14,60).rotate((0,0,0),(0,1,0),-90).translate((-14,y,z))
            front=m.cylinder(14,30).rotate((0,0,0),(0,1,0),90).translate((13,y,z))
