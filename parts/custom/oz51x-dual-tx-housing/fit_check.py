"""
Fit check for this variant — delegates to the shared family fit check
(parts/custom/oz510-dual-housing/fit_check.py) with this part's directory;
bay handedness and vendor STEPs come from this part's params.json.
"""
