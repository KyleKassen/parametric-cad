"""OZ51x Dual-TX vertical housing — thin shared-builder wrapper.

The RF and TTL transmitter bays are stacked vertically.  The removable lid
is the right-side service cover, while front SMA and rear SC/APC/DE-9 access
remain aligned with the horizontal connector axes.
"""
