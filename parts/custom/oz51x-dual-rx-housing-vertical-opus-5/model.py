"""OZ51x Dual-RX vertical housing, production refinement — Opus 5 edition.

RF and TTL receiver bays stacked vertically, wall-mounted, with the removable
service cover on the large outward face.
